...
const IMAGES = {
  ...
  COURSES_DOT_DATA: "/images/img_e49acf40f250.jpg",
  COURSES_DOT_DESIGN: "/images/img_b650b08c891f.jpg",
  COURSES_DOT_REACT: "/images/img_c3c198615d55.jpg",
  HOME_DOT_HERO: "/images/img_3311a791e716.jpg",
} as const;
        ...
        <div className="desktop-actions">
          {currentUser ? (
            ...
            <>
              ...
              <Link className="button button-sm button-primary" to="/user/register">
                Đăng ký miễn phí
                <ArrowUpRight size={16} />
              </Link>
            </>
      ...
      <div className={`mobile-panel ${isOpen ? "is-open" : ""}`}>
        ...
        <div className="mobile-actions">
          {currentUser ? (
            ...
            <>
              <Link className="button button-secondary" to="/user/login" onClick={closeMenu}>
                Đăng nhập
              </Link>
              <Link className="button button-primary" to="/user/register" onClick={closeMenu}>
                Đăng ký miễn phí
              </Link>
            </>
          )}
      ...
      <div className="site-container hero-grid">
        <div className="hero-copy">
          ...
          <div className="hero-actions">
            {isLoggedIn ? (
              <Link className="button button-lg button-primary" to="/student/my-courses">
                Xem khóa học của tôi
                <ArrowRight size={18} />
              </Link>
            ) : (
              <Link className="button button-lg button-primary" to="/user/register">
                Bắt đầu học miễn phí
                <ArrowRight size={18} />
              </Link>
            )}
            <Link className="button button-lg button-ghost" to="/courses">
          ...
          <div className="hero-trust">
            ...
            <div>
              <div className="rating-line">
                <span className="stars" aria-label="5 trên 5 sao">
        ...
        <div className="hero-visual" aria-label="Minh họa trải nghiệm học trực tuyến">
          <img
  ...
  <section className="section section-light" id="courses" data-reveal>
    <div className="site-container">
      <div className="section-heading-row">
        ...
        />
        <Link className="inline-link desktop-only-link" to="/courses">
          Xem tất cả khóa học
          <ArrowRight size={17} />
        </Link>
      </div>
      ...
      <Link className="button button-secondary mobile-section-cta" to="/courses">
        Xem tất cả khóa học
        <ArrowRight size={17} />
      </Link>
    </div>
  ...
  <section className="section why-section" id="why-eduvi" data-reveal>
    <div className="site-container why-layout">
      <div className="why-copy">
        ...
        <Link className="inline-link" to="/courses">
          ...
          <div className="testimonial-track">
            {testimonials.map((testimonial) => (
              <article className="testimonial-card" key={testimonial.name}>
                ...
                <div className="stars testimonial-stars" aria-label="5 trên 5 sao">
                  {[0, 1, 2, 3, 4].map((star) => (
        ...
        <div className="cta-panel">
          ...
          <div className="cta-copy">
            ...
            <div className="cta-actions">
              {isLoggedIn ? (
                <Link className="button button-lg button-white" to="/student/my-courses">
                  Học ngay hôm nay
                  <ArrowRight size={18} />
                </Link>
              ) : (
                <Link className="button button-lg button-white" to="/user/register">
                  Đăng ký miễn phí
                  <ArrowRight size={18} />
                </Link>
              )}
